// #![feature(try_reserve, drain_filter)]
// // use alloc_wg::{
// //     boxed::Box,
...
//     }
//
//     let mut v = vec![BadElem(1), BadElem(2), BadElem(0x0bad_beef), BadElem(4)];
//     v.truncate(0);
// }
//
// #[test]
...
//         v.set_len(usize::max_value());
//     }
//     for _ in v.drain(usize::max_value() - 1..usize::max_value()) {}
//     assert_eq!(v.len(), usize::max_value() - 1);
// }
//
// #[test]
...
// //    let borrowed: &[_] = &["borrowed", "(slice)"];
// //    let owned = vec!["owned", "(vec)"];
// //    assert_eq!(Vec::from(Cow::Borrowed(borrowed)), vec![
// //        "borrowed", "(slice)"
// //    ]);
...
//             if empty_bytes.try_reserve(MAX_CAP + 1).is_ok() {
//                 panic!("isize::MAX + 1 should trigger an OOM!")
//             }
//
//             // Check usize::MAX is an OOM
//             if empty_bytes.try_reserve(MAX_USIZE).is_ok() {
...
//                 panic!("isize::MAX + 1 should trigger an overflow!");
//             }
//         } else if ten_bytes.try_reserve(MAX_CAP - 9).is_ok() {
//             panic!("isize::MAX + 1 should trigger an OOM!")
//         }
...
//                 panic!("isize::MAX + 1 should trigger an overflow!");
//             }
//         } else if ten_u32s.try_reserve(MAX_CAP / 4 - 9).is_ok() {
//             panic!("isize::MAX + 1 should trigger an OOM!")
//         }
...
//             }
//         } else {
//             if empty_bytes.try_reserve_exact(MAX_CAP + 1).is_ok() {
//                 panic!("isize::MAX + 1 should trigger an OOM!")
//             }
//
//             if empty_bytes.try_reserve_exact(MAX_USIZE).is_ok() {
//                 panic!("usize::MAX should trigger an OOM!")
//             }
//         }
//     }
...
//                 panic!("isize::MAX + 1 should trigger an overflow!");
//             }
//         } else if ten_bytes.try_reserve_exact(MAX_CAP - 9).is_ok() {
//             panic!("isize::MAX + 1 should trigger an OOM!")
//         }
...
//         }
//         if guards_against_isize {
//             if ten_u32s.try_reserve_exact(MAX_CAP / 4 - 9).is_ok() {
//                 panic!("isize::MAX + 1 should trigger an overflow!");
//             }
//         } else if ten_u32s.try_reserve_exact(MAX_CAP / 4 - 9).is_ok() {
//             panic!("isize::MAX + 1 should trigger an OOM!")
//         }
